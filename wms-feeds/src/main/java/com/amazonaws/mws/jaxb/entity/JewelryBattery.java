...
/**
 * <p>Java class for JewelryBattery complex type.
 * 
...
@XmlType(name = "JewelryBattery", propOrder = {
    "areBatteriesIncluded",
    "areBatteriesRequired",
    "batterySubgroup"
})
public class JewelryBattery {
    ...
    protected List<JewelryBattery.BatterySubgroup> batterySubgroup;
     ...
     * {@link JewelryBattery.BatterySubgroup }
     * 
     * 
     */
    public List<JewelryBattery.BatterySubgroup> getBatterySubgroup() {
        if (batterySubgroup == null) {
            batterySubgroup = new ArrayList<JewelryBattery.BatterySubgroup>();
        }
