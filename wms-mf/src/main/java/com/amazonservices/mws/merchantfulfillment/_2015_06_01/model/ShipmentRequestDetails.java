...
public class ShipmentRequestDetails extends AbstractMwsObject {
    ...
    /** Value constructor. */
    public ShipmentRequestDetails(String amazonOrderId,String sellerOrderId,List<Item> itemList,Address shipFromAddress,PackageDimensions packageDimensions,Weight weight,XMLGregorianCalendar mustArriveByDate,ShippingServiceOptions shippingServiceOptions) {
        this.amazonOrderId = amazonOrderId;
        this.sellerOrderId = sellerOrderId;
        this.itemList = itemList;
        this.shipFromAddress = shipFromAddress;
