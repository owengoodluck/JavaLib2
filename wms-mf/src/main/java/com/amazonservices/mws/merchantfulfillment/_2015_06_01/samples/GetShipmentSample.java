...
/** Sample call for GetShipment. */
public class GetShipmentSample {
     ...
     * @return The response.
     */
    public static GetShipmentResponse invokeGetShipment(
            MWSMerchantFulfillmentService client, 
            GetShipmentRequest request) {
        try {
            // Call the service.
            GetShipmentResponse response = client.getShipment(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetShipmentSample.invokeGetShipment(client, request);
