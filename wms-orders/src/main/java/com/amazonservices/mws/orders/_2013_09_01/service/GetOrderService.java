...
public class GetOrderService {
     ...
     * @return The response.
     */
    private GetOrderResponse invokeGetOrder(  MarketplaceWebServiceOrders client,  GetOrderRequest request) {
        try {
            // Call the service.
    ...
    public static void main(String[] args) {
    	new GetOrderService().getOrderByID("111-2651851-0898603");
    }
