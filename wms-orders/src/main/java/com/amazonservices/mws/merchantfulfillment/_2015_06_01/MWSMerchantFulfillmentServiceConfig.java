...
public class MWSMerchantFulfillmentServiceConfig {
    ...
    static final String DEFAULT_SERVICE_PATH = "MerchantFulfillment/2015-06-01";
    ...
    public MWSMerchantFulfillmentServiceConfig withMaxConnections(int maxConnections) {
        cc.setMaxConnections(maxConnections);
        return this;
    }
    ...
    public MWSMerchantFulfillmentServiceConfig withServiceURL(String aserviceUrl) {
    ...
    public MWSMerchantFulfillmentServiceConfig withMaxAsyncQueueSize(int size) {
        cc.setMaxAsyncQueueSize(size);
        return this;
    }
    ...
    public MWSMerchantFulfillmentServiceConfig withMaxAsyncThreads(int threads) {
        cc.setMaxAsyncThreads(threads);
        return this;
    }
